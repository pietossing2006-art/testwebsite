    ...
    <section className="sticky top-3 z-20 rounded-[28px] border border-white/10 bg-[linear-gradient(180deg,rgba(7,16,26,0.96),rgba(7,16,26,0.88))] p-4 shadow-[0_24px_80px_rgba(0,0,0,0.28)] backdrop-blur md:p-5">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div className="min-w-0">
          ...
          <p className="mt-1 max-w-2xl text-sm text-white/55">
            Media browser สำหรับไถดูรูปและวิดีโอแบบลื่นขึ้น เปิดดูต่อเนื่องได้เร็ว และตัดน้ำหนักส่วนที่ไม่จำเป็นกับงานดูสื่อออก
          </p>
        </div>
      ...
      <div className="mt-4 grid gap-3 xl:grid-cols-[minmax(0,1fr)_auto]">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <ToolbarButton onClick={onToggleSortOrder} title="สลับลำดับการเรียง">
